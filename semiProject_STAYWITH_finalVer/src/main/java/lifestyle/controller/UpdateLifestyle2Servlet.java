...
/**
 * Servlet implementation class UpdateLifestyle2Servlet
 */
@WebServlet(name = "UpdateLifestyle2", urlPatterns = { "/updateLifestyle2" })
public class UpdateLifestyle2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateLifestyle2Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//4.결과 처리
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/lifestyle/updatePayLifestyle.jsp");
