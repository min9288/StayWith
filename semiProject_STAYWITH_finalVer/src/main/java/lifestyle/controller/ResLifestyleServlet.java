...
/**
 * Servlet implementation class ResLifestyleServlet
 */
@WebServlet(name = "ResLifestyle", urlPatterns = { "/resLifestyle" })
public class ResLifestyleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ResLifestyleServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//4.결과처리
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/lifestyle/resLifestyle.jsp");
